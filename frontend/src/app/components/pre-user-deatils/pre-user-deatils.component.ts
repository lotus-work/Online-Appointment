...
@Component({
  selector: 'app-pre-user-deatils',
  templateUrl: './pre-user-deatils.component.html',
  styleUrls: ['./pre-user-deatils.component.css']
})
export class PreUserDeatilsComponent {
  ...
  updateOnboardingUserData(updateForm: NgForm) {
    ...
    this._userService.updateOnboardingUserData(String(this.userId), updateForm.value.about, timezonVal).subscribe(
      res => {
        setTimeout(() => {
          /** spinner ends after 5 seconds */
          this.spinner.hide();
